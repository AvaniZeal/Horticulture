    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch(position) {
                ...
                case 0: return AskExpertiseFragment.newInstance("FirstFragment, Instance 1");
                case 1: return ViewAdvisoryFragment.newInstance("SecondFragment, Instance 1");
